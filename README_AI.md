# 巴别回声 Babel Echo — 开发者与 AI 接手文档

> 本文供维护者与 AI 编程助手阅读。面向使用者的中英文介绍和上手步骤见 [README.md](README.md)。
...
仓库公开并提供 GitHub 预发布版，但当前未提供开源许可证；`package.json` 中的 `"private": true` 仅用于防止误发布到 npm。使用到的第三方服务：
